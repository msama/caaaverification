 ...
 *
 */
public class ContextHazardDetectionOptimizedTest {
	 ...
	 */
	@Test
	public void testDetectFaults_priority() {
		this._afsm.createVariable("A", this._cv);
		this._afsm.createVariable("B", this._cv);
		this._afsm.createVariable("C", this._cv);
		this._afsm.createVariable("D", this._cv);
...
(0110)
	 ...
	 */
	@Test
	public void testApplyRegression_4var() {
		this._afsm.createVariable("A", this._cv);
		this._afsm.createVariable("B", this._cv);
		this._afsm.createVariable("C", this._cv);
		this._afsm.createVariable("D", this._cv);
		...
		Fault[] f=this._chDet.detectFaults();
		try {
			this._chDet.printFaultsToStream(f, new PrintWriter("./out/ContextHazardDetectionOptimizedTest.txt"));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		assertEquals(44, f.length);
	}
