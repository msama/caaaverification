 ...
 *
 */
public class ValidatePhoneAdapter {
	...
	public static void main(String[] args) {
		new ValidatePhoneAdapter();
	}

	public ValidatePhoneAdapter() {
		afsm = (new PhoneAdapterAfsm()).getAdaptationFiniteStateMachine();
